            ...
            <div className="flex flex-col gap-[2rem] mt-[2rem]">
                <div className="flex items-center gap-[3rem]">
                    ...
                    <SelectBox
                        ...
                        active={selectedAktivitas === "Sangat rendah"}
                    ...
                    <SelectBox
                        label={"Ringan"}
                        icon={Mars}
                        active={selectedAktivitas === "Ringan"}
                    ...
                    <SelectBox
                        label={"Sedang"}
                        icon={Mars}
                        active={selectedAktivitas === "Sedang"}
                ...
                <div className="flex justify-center items-center gap-[3rem]">
                    ...
                    <SelectBox
                        label={"Berat"}
                        icon={Mars}
                        active={selectedAktivitas === "Berat"}
                    ...
                    <SelectBox
                        label={"Ekstra berat"}
                        icon={Mars}
                        active={selectedAktivitas === "Ekstra berat"}
